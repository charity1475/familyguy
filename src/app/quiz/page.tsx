        ...
        >
            ...
            <div className="md:w-[50%] flex flex-col gap-5">
                ...
                <Link
                    ...
                    className="flex items-center justify-center gap-1 px-5 py-4 font-semibold text-cyan-500 transition-colors rounded-md outline duration-600 hover:bg-cyan-950"
                >
